            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            <label for="residencia" class="col-md-4 col-form-label text-md-right">{{ __('Residencia') }}</label>

                            <div class="col-md-6">
                                <input id="residencia"  class="form-control{{ $errors->has('residencia') ? ' is-invalid' : '' }}" name="residencia" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono"  class="form-control{{ $errors->has('telefono') ? ' is-invalid' : '' }}" name="telefono" required>
